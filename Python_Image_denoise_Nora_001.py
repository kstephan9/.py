...
from DefaultItems import ImagesTestFolder
Nora_file = os.path.join(ImagesTestFolder,"20120527_052941_Nora.JPG")

#Nora = Image(Nora_file)
#original = img_as_float(data.chelsea()[100:250, 50:300])
original = img_as_float(rgb2gray(Nora_file))
